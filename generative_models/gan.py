...
def discriminator_loss(logits_real, logits_fake):
  ...
  pos = F.binary_cross_entropy_with_logits(logits_real, torch.ones_like(logits_real, 
                                                                        device=logits_real.device))
  neg = F.binary_cross_entropy_with_logits(logits_fake, torch.zeros_like(logits_fake, 
